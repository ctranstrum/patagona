module.exports = {
  ...
  body: (p) => {
    ...
    const vias = p.vias
      ? `
        (pad 1 thru_hole circle (at ${right}2.25 2.075) (size 0.6 0.6) (drill 0.3) (layers *.Cu) ${netStr(p.A)})
        (pad 2 thru_hole circle (at ${left}0.75 2.075) (size 0.6 0.6) (drill 0.3) (layers *.Cu) ${netStr(p.COM)})
